// ExecutionContext is provenance-only.
// It may carry execution source, routing, and task/workflow metadata.
// It must not carry internal reasoning, prompt content, or internal monologue.
