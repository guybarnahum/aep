...
| PR18 | HR / staffing system | 🟡 PR18E complete. Staffing contracts, advisory gap detection, hiring request lifecycle, and hiring-to-employee linkage exist; staffing dashboard actions and CI expansion remain. |
