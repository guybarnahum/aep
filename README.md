...
| PR18 | HR / staffing system | 🟢 Complete. Staffing contracts, gap detection, hiring request lifecycle, hiring-to-employee linkage, dashboard, and CI enforcement implemented. |
